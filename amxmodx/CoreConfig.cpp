...
void CoreConfig::ExecuteMainConfig()
{
	...
	ke::SafeSprintf(path, sizeof(path), "%s/%s/%s", g_mod_name.chars(), get_localinfo("amxx_configsdir", "addons/ktpamx/configs"), MainConfigFile);
...
bool CoreConfig::ExecuteAutoConfig(CPluginMngr::CPlugin *plugin, AutoConfig *config, bool can_create)
{
	...
	const char *configsDir = get_localinfo("amxx_configsdir", "addons/ktpamx/configs");
